        ...
        <div className="flex min-h-screen relative overflow-hidden font-['Inter'] items-center justify-center">
            ...
            {isLogin && (
                <>
                    ...
                    <div className="absolute top-20 right-20 w-48 h-48 bg-blue-200/40 rounded-full blur-3xl animate-cartoon-float" style={{ animationDelay: '1.5s' }}></div>
                    <div className="absolute bottom-20 left-1/4 w-64 h-64 bg-sky-200/30 rounded-full blur-3xl animate-cartoon-float" style={{ animationDelay: '3s' }}></div>
                    ...
                    <div className="absolute left-[5%] bottom-[15%] w-[180px] h-[300px] hidden md:block perspective-1000">
                        {/* Door Frame */}
                        <div className="absolute inset-0 border-8 border-blue-900/80 rounded-t-full bg-blue-900/10 shadow-xl"></div>
                        ...
                        <div className="absolute inset-2 top-2 rounded-t-[90px] bg-blue-700 origin-left shadow-2xl animate-door-cycle border border-blue-600">
                            {/* Door Details */}
                            <div className="absolute top-1/2 right-4 w-3 h-3 bg-yellow-400 rounded-full shadow-sm"></div> {/* Knob */}
                            <div className="absolute inset-4 border-2 border-dashed border-blue-800/30 rounded-t-[80px]"></div> {/* Detail */}
                        </div>
            ...
            {isRegister && (
                <>
                    ...
                    <div className="absolute inset-0 bg-gradient-to-br from-cyan-500 via-green-400 to-orange-400"></div>
                    <div className="absolute inset-0 bg-gradient-to-tr from-cyan-900/60 via-transparent to-green-900/40"></div>

                    {/* Organic Pattern Shapes */}
                    <div className="absolute top-0 left-0 w-full h-full opacity-10">
                        <div className="absolute top-[10%] left-[15%] w-64 h-64 bg-blue-300 rounded-full blur-3xl animate-grow-pulse"></div>
                        ...
                        <div className="absolute top-[40%] right-[20%] w-48 h-48 bg-blue-300 rounded-full blur-2xl animate-grow-pulse" style={{ animationDelay: '1.5s' }}></div>
                    </div>
            ...
            <div className={`w-full max-w-md p-1 relative z-10 mx-4 ${isLogin ? 'animate-bounce-in' : ''}`}>
                ...
                <div className={`absolute inset-0 rounded-[2.5rem] -m-[2px] pointer-events-none ${isLogin ? 'bg-gradient-to-tr from-yellow-300 via-sky-300 to-sky-300' :
                    'bg-gradient-to-b from-cyan-300/30 via-green-300/20 to-orange-300/30'
                    }`}></div>

                <div className={`
                    relative 
                    ${isLogin ? 'bg-white/60 backdrop-blur-xl border-white/40 shadow-xl shadow-blue-500/10' : 'bg-black/40 backdrop-blur-2xl border-white/10 shadow-2xl shadow-black/50'}
                    rounded-[2.5rem] 
                    border 
                    overflow-hidden
                `}>
                    ...
                    <div className="px-8 pt-10 pb-6 text-center">
                        <div className="flex items-center justify-center gap-3 mb-6">
                            <div className={`w-14 h-14 rounded-2xl flex items-center justify-center shadow-lg ring-4 ring-white/50 ${isLogin ? 'bg-gradient-to-tr from-yellow-400 to-orange-500 shadow-blue-200 text-white' :
                                'bg-gradient-to-br from-cyan-600 to-green-600 shadow-blue-500/25 ring-white/20'
                                }`}>
